...
<link rel="stylesheet" href="${pageContext.request.contextPath}/statics/hyccss/detailfocash.css">
<script src="${pageContext.request.contextPath}/statics/hycjs/detailfocash.js"></script>
        <div style="width:1800px;left: 210px;top: 50px;position: absolute;">
            <div style="height: 50px;line-height: 50px"><span>电子银行>>提现明细</span></div>
            <hr />
